...
void Spi::Setup(SpiPinOpt pins, u32_t target_clk) {
  ...
  switch (pins) {
  case PINS_PA47:
    PORTA.DIR  = (PORTA.DIR & 0x0F) | 0b11010000;  // setup all pins
    port_mux = PORTMUX_SPI0_DEFAULT_gc;
    break;
  case PINS_PC03:
    PORTC.DIR  = (PORTC.DIR & 0xF0) | 0b00001101;
    port_mux = PORTMUX_SPI0_ALT1_gc;
    break;
  case PINS_PE03:
    PORTE.DIR  = (PORTE.DIR & 0xF0) | 0b00001101;
    port_mux = PORTMUX_SPI0_ALT2_gc;
    break;
  default:
  case PINS_NONE:
    port_mux = PORTMUX_SPI0_NONE_gc;
    break;
  }
  PORTMUX.TWISPIROUTEA = (PORTMUX.TWISPIROUTEA & PORTMUX_TWI0_gm) | port_mux;
